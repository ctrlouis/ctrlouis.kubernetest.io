...
Pour bien comprendre l'intérêt de ce type d'outil, une mise en application est nécessaire. Un environnement d'évaluation devra être mis en place, à l'aide de simples PC sous Linux faisant tourner des images Docker. Partant de cette infrastructure, vous mettrez en place Kubernetes
afin d'administrer facilement ces machaines et tester le comportement lors de montée en charge ou indisponibilité de machine.
...
Les notions de base de Docker seront acquis en début de projet afin de bien appréhender les concepts attachés à ces outils.
