---
title: Message App
prev: /tests/simple-api
---

# Message app

En suivant la même démarche que pour la [Simple API](/test/simple-api), nous avons décidé de tenter de **déployer une application un peu plus concrète**.

L'application est composée d'une partie **Back** et d'une partie **Front**, chacune étant **déployée** et **exposée**.

La partie **Back** est développée en **NodeJS** et les données sont stockées dans une base **MongoDB** tandis que la partie **Front** est développée en **VueJS**.
